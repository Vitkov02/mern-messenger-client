...
const Signup = () => {
    return (
        <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
            <div className="w-full p-6 rounded-lg shadow-md bg-gray-100 bg-clip-padding backdrop-filer backdrop-blur-lg bg-opacity-1">
                ...
                <form>
                    <div>
                        ...
                        <input className="w-full input input-bordered h-10" type="text"  placeholder="Enter name"/>
                    </div>
                    ...
                    <div>
                        <button className="btn btn-block btm-sm bg-blue-700 mt-2">SignUp</button>
                    </div>
                </form>
            </div>
        </div>
